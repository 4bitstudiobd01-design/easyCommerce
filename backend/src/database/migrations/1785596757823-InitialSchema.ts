...
export class InitialSchema1785596757823 implements MigrationInterface {
    name = 'InitialSchema1785596757823'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum_old" AS ENUM('SUPER_ADMIN', 'STORE_OWNER', 'STORE_MANAGER', 'FULFILLMENT_STAFF', 'ACCOUNTANT', 'CUSTOMER')`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" TYPE "public"."users_role_enum_old" USING "role"::"text"::"public"."users_role_enum_old"`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'STORE_OWNER'`);
