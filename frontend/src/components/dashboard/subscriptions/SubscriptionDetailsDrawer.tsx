        ...
        <div className="w-screen max-w-md bg-white shadow-2xl border-l border-slate-200 flex flex-col animate-in slide-in-from-right duration-200">
          ...
          <div className="p-6 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                className={`w-12 h-12 rounded-2xl ${subscription.avatarBg} text-white font-bold text-base flex items-center justify-center shadow-xs`}
              >
              ...
              <div className="bg-slate-50/70 rounded-2xl p-4 border border-slate-100 space-y-3 text-xs">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-slate-700">
                    {subscription.nextBillingDate.date} ({subscription.nextBillingDate.subtext})
                  </span>
                </div>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                >
                  ...
                  <span>Cancel / Pause Subscription</span>
                </button>
              </div>
            </div>
          </div>
