  ...
  return (
    <header className="h-16 bg-white/95 backdrop-blur-md border-b border-gray-200/90 px-6 flex items-center justify-between sticky top-0 z-20 shadow-xs">
        ...
        <form onSubmit={handleSearch} className="relative w-full max-w-md">
          <div className="relative flex items-center">
            ...
            <input
              ...
              placeholder="Search merchants, stores, transactions..."
              className="w-full pl-9 pr-14 py-2 bg-gray-50/80 hover:bg-gray-100/80 focus:bg-white border border-gray-200/80 focus:border-emerald-500 rounded-xl text-xs text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all"
            />
      ...
      <div className="flex items-center gap-4 shrink-0">
        ...
        <Link
          href="/dashboard"
          className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-white border border-gray-200 hover:border-gray-300 rounded-xl text-xs font-semibold text-gray-700 hover:text-gray-900 shadow-xs hover:bg-gray-50/80 transition-all"
        >
