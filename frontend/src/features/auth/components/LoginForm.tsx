  ...
  return (
    <div className="w-full max-w-[420px] bg-white rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/50 p-10 flex flex-col items-center">
      ...
      <div className="w-full grid grid-cols-3 gap-3 mb-8">
        <button className="h-10 flex items-center justify-center gap-2 border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors">
      ...
      {/* Security Badge */}
      <div className="flex items-center gap-2.5 text-[11px] font-medium text-slate-500 max-w-[280px] text-left">
