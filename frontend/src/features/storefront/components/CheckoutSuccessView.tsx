...
function SuccessContent() {
  ...
  // The route slug (store-scoped route) is authoritative; the query param is the
  // fallback for the legacy /checkout/success route.
  const storeSlug =
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans" style={{ ['--brand' as any]: primaryColor }}>
      <ShopEaseNavbar
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-lg w-full overflow-hidden p-8 text-center space-y-6 mt-10">
