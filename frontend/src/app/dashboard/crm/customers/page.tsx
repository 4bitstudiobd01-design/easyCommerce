...
export default function CrmCustomersPage() {
  ...
  return (
    <div className="space-y-6 pb-12 relative">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold text-slate-400 mb-1">
            ...
            <span>&gt;</span>
            <span className="text-slate-700">Customers 360</span>
          </div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Customers 360</h1>
        </div>
      ...
      {/* VIEW PANEL 1: ANALYTICS & REPORTS */}
      {activeView === 'analytics' && (
      ...
      {/* VIEW PANEL 3: CUSTOMER DIRECTORY */}
      {activeView === 'directory' && (
        <>
      ...
      {/* CUSTOMER DETAIL DRAWER (MAIN BRANCH LAYOUT) */}
